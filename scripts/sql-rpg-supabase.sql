-- Supabase Postgres icin SQL RPG veritabani kurulumu
-- Supabase SQL Editor icinde calistirilacak.
...
-- ======================================
-- OYUNLASTIRMA SEMASI (Moduller, Yetenekler, Basarimlar, Liderlik Tablosu)
-- ======================================

-- 1. MODULLER (SQL Ogrenme Yolu) - ILK ONCE OLUSTUR VE ILK VERILERI EKLE
...
-- Sorulardan (challenges) once SQL konu modullerini ekle
...
-- 2. Sorulari modullere baglamak icin guncelle
...
select * from (
  values
    ...
    -- MODUL 2: WHERE ve Filtreleme (10 soru)
    ...
    -- MODUL 3: ORDER BY ve LIMIT (10 soru)
    ...
    -- MODUL 4: GROUP BY ve Aggregates (10 soru)
    ...
    -- MODUL 5: Advanced Queries (10 soru)
...
-- 3. KULLANICI PROFILLERI (Karakter Verileri)
...
-- 4. KULLANICI YETENEKLERI (Yetenek Agaci Takibi)
...
-- 6. MODUL ILERLEMESI (Kullanici bazli tamamlamayi takip etmek icin)
...
-- 9. LIDERLIK TABLOSU ANLIK GORUNTUSU (Haftalik)
...
-- ======================================
-- SATIR BAZLI GUVENLIK (ROW LEVEL SECURITY)
-- ======================================
...
-- Kullanici sadece kendi profilini gorebilir/guncelleyebilir
...
-- Kullanici sadece kendi yeteneklerini gorebilir/yonetebilir
...
-- Kullanici sadece kendi basarimlarini gorebilir/yonetebilir
...
-- Kullanici sadece kendi modul ilerlemesini gorebilir/yonetebilir
...
-- Kullanici sadece kendi gunluk denemelerini gorebilir/yonetebilir
...
-- ======================================
-- BASLANGIC VERILERI (SEED DATA - Ekstra)
-- ======================================
...
-- Gunluk gorevleri ekle (bugun ve sonraki 6 gun icin)
...
-- ======================================
-- Uygulamanin bekledigi Edge Function yapisi:
-- isim: submit-sql
-- body: { challengeId: number, sql: string }
-- cevap: { success: boolean, feedback: string, damage: number, critical: boolean, xpAwarded: number }

-- ======================================
-- NESTJS BACKEND TABLOLARI (Veritabani Dersi Degerlendirmesi icin)
-- ======================================
...
-- NestJS Tablolari icin RLS'yi aktif et
alter table public.arena_questions enable row level security;
alter table public.user_scores enable row level security;

-- NestJS Tablolari icin RLS Politikalari
...
-- NestJS Tablolari icin Baslangic Verileri
